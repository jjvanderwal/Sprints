...
void loop () 
{
  ...
  /* CHANGE THIS SECTION TO EDIT SENSOR DATA BEING COLLECTED */ 
    ...
    float t0= sensor0.getTempCByIndex(0);
    ...
    //Collect data
    postData += ("Temp 0:" + String(t0) + ",light 0:" + String(s0));
    postData += (",Temp 1:" + String(t1) + ",Light 1:" + String(s1));
    postData += (",Temp 2:" + String(t2) + ",Light 2:" + String(s2));
    postData += (",Temp 3:" + String(t3) + ",Light 3:" + String(s3));
