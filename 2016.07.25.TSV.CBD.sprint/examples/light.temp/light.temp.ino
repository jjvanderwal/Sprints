/*
  ...
  * Pin D12 - DS18B20 temperature sensor
  * Pin A0 - Light sensor
  * Pin A1 - Light sensor
  * Pin A2 - Light sensor
  * Pin A3 - Light sensor
...
OneWire oneWire3(12);          // Setup a oneWire instance to communicate with any OneWire devices (not just Maxim/Dallas temperature ICs)
...
void loop () 
{
  ...
  postData += (",T3:" + String(sensor3.getTempCByIndex(0)) + ",L3:" + String(analogRead(3)));
  debugSerial.println(postData);                                    //for debugging purposes, show the data
  responseCode = mdot.sendPairs(postData);                          // post the data
